...
The feature of interest is the logerror which shows the order of magnitude deviation of the predicted price from the sale price.   

### What other features in the dataset do you think will help support your \
investigation into your feature(s) of interest?

I think the coordinate of each property (x and y) are important features which could be related to the magnitude of logerror. I plan to perform more investigations on these features.

### Did you create any new variables from existing variables in the dataset?

I created a new feature called "age" to better show if a property is newly built or not. The existing feature "year_built" contains this information but I think it's quite easier to comprehend the age than the year_built.
